...
public class ShopService {
    ...
    private ArrayList<Product> createProducts() {
        ...
        arrayList.add(new Product("Shirt",55,Category.CLOTHING));
        arrayList.add(new Product("Book",12,Category.BOOKS));
        arrayList.add(new Product("Electronic",34,Category.ELECTRONICS));
        arrayList.add(new Product("Food",43,Category.FOOD));
        arrayList.add(new Product("Toy",10,Category.TOYS));

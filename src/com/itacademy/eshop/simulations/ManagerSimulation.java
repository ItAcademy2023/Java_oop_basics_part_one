...
public class ManagerSimulation {
    ...
    private void addThreeNewProducts() {
        ...
        Product book = new Product("Book", 1000, Category.BOOKS);
        Product shirt = new Product("Shirt", 1000, Category.CLOTHING);
    ...
    private void findAndRemoveOneProduct() {
        /**
         * manager searches for a product with the name "Laptop" (the one added a moment before) and removes it from the shop
         */

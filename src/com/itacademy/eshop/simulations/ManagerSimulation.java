...
public class ManagerSimulation {
    ...
    private void addThreeNewProducts() {
         ...
         */
        Product book = new Product("Book", 350, Category.BOOKS);
        Product laptop = new Product("Laptop", 1500, Category.ELECTRONICS);
        Product shirt = new Product("Shirt", 11, Category.CLOTHING);
    ...
    private void changePriceForOneProduct() {
         ...
         */
        shop.changePriceForProduct("Shirt", 55);
